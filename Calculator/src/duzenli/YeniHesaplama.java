...
public class YeniHesaplama {
	...
	public void bol(String dizi[],int isaretindisi){
		...
		dizi[isaretindisi-1]=String.valueOf(donen);		// ÝÞARET ORTADA ve SONDAYSA (-1)
	}
	...
	public void kok(String dizi[],int isaretindisi){
		...
		dizi[isaretindisi]=String.valueOf(donen);		// ÝÞARET ONDEYSE (0)
	}
